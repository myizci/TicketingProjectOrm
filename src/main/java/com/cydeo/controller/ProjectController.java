...
public class ProjectController {
   ...
   private final UserService userService;
    ...
    public String getProjectByManager(Model model) {
       ...
       // this method brings all projects for a hard coded manager...
    ...
    public String getProjectByManager(Model model) {
        ...
        List<ProjectDTO> projects = projectService.listAllProjectDetails(); // this is a method
        // to pull all projects for a certain manager
     model.addAttribute("projects",projects);
